...
async function convertCurrency() {
    ...
    const currencyToConvert = document.querySelector('#currency-to-convert > span')
    ...
    if (selectToConvert.value === 'dolar') {
        ...
        if (selectConverted.value === 'real') {
            ...
            convertedValue.innerHTML = formatCurrency('euro', (valueInput * (dolar / euro)))
        } else {
    ...
    if (selectToConvert.value === 'euro') {
        ...
        if (selectConverted.value === 'real') {
            ...
            convertedValue.innerHTML = formatCurrency('dolar', (valueInput * (euro /dolar)))
        } else {
...
function changeCurrency() {
    ...
    const nameCurrencyToConvert = document.querySelector('#name-currency-to-convert > span')

    const convertedCurrencyImage = document.querySelector('.converted-currency-image')
    const nameConvertedCurrency = document.querySelector('#name-converted-currency > span')
